...
<div class="mtc-service-content">
  ...
  <div class="mtc-feature-grid">
    ...
    <div class="mtc-feature-card">
      <span class="mtc-feature-title">When Do You Need a Certificate?</span>
      <span class="mtc-feature-desc">You need a Safety Standards Certificate when registering a rebuilt vehicle, transferring a used vehicle to a new owner, registering a vehicle from another province or country, or changing a vehicle's status from unfit to fit.</span>
    </div>
    <div class="mtc-feature-card">
      <span class="mtc-feature-title">What to Expect</span>
      <span class="mtc-feature-desc">When you bring in your vehicle, we use government-regulated inspection criteria to determine if your vehicle meets minimum safety standards. The inspection is now conducted through the official DriveON portal with the Government of Ontario.</span>
    </div>
    <div class="mtc-feature-card">
  ...
  <p class="mtc-service-note">
    <strong style="color:#f3832e">Element Fleet Cards Accepted</strong> — MTC Tire Oakville accepts the Element fleet card for business vehicle services and tire purchases. Contact us to set up your account.
  </p>
</div>
<!-- /wp:html -->
