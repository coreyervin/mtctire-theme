...
<div class="wp-block-columns">
  ...
  <div class="wp-block-column" style="background-color:#111111;padding-top:60px;padding-right:48px;padding-bottom:60px;padding-left:48px">
    ...
    <!-- wp:paragraph {"style":{"color":{"text":"#888888"},"typography":{"fontSize":"0.82rem"}}} --><p style="color:#888888;font-size:0.82rem">MTC Tire Oakville has been serving Oakville drivers since 2005. We're not a chain — we're your neighbours. Our team gives straight talk, honest prices, and service that earns repeat customers for life.</p><!-- /wp:paragraph -->
